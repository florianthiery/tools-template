        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (selValue === "turtle") {
              ...
              $("#rdffile-div").html("");
              $("#rdffile-div").html(
                "<textarea id='rdf' style='width:1px;height:auto;'></textarea>"
              );
              var turtle = CodeMirror.fromTextArea(
            ...
            if (selValue === "cypher") {
              ...
              $("#cypherfile-div").html("");
              $("#cypherfile-div").html(
                "<textarea id='cypher' style='width:1px;height:auto'></textarea>"
              );
              var cypher = CodeMirror.fromTextArea(
                document.getElementById("cypher"),
                {
